...
test('linearMapVector2', () => {
    expect(linearMapVector2(new Vec2(0, 0), new Vec2(0, 0), new Vec2(1, 1), new Vec2(0, 0), new Vec2(1, 1))).toEqual(new Vec2(0, 0));
    expect(linearMapVector2(new Vec2(1, 0), new Vec2(0, 0), new Vec2(1, 1), new Vec2(0, 0), new Vec2(1, 1))).toEqual(new Vec2(1, 0));
    expect(linearMapVector2(new Vec2(2, 0), new Vec2(0, 0), new Vec2(1, 1), new Vec2(0, 0), new Vec2(1, 1))).toEqual(new Vec2(2, 0));
    expect(linearMapVector2(new Vec2(2, 1), new Vec2(0, 0), new Vec2(1, 1), new Vec2(0, 0), new Vec2(1, 1))).toEqual(new Vec2(2, 1));
    expect(linearMapVector2(new Vec2(2, 2), new Vec2(0, 0), new Vec2(1, 1), new Vec2(0, 0), new Vec2(1, 1))).toEqual(new Vec2(2, 2));
    expect(linearMapVector2(new Vec2(2, 2), new Vec2(1, 0), new Vec2(1, 1), new Vec2(0, 0), new Vec2(1, 1))).toEqual(new Vec2(1, 2));
    expect(linearMapVector2(new Vec2(2, 2), new Vec2(2, 0), new Vec2(1, 1), new Vec2(0, 0), new Vec2(1, 1))).toEqual(new Vec2(0, 2));
    expect(linearMapVector2(new Vec2(2, 2), new Vec2(2, 1), new Vec2(1, 1), new Vec2(0, 0), new Vec2(1, 1))).toEqual(new Vec2(0, 1));
    expect(linearMapVector2(new Vec2(2, 2), new Vec2(2, 2), new Vec2(1, 1), new Vec2(0, 0), new Vec2(1, 1))).toEqual(new Vec2(0, 0));
    expect(linearMapVector2(new Vec2(2, 2), new Vec2(2, 2), new Vec2(1, 1), new Vec2(1, 0), new Vec2(1, 1))).toEqual(new Vec2(1, 0));
    expect(linearMapVector2(new Vec2(2, 2), new Vec2(2, 2), new Vec2(1, 1), new Vec2(2, 0), new Vec2(1, 1))).toEqual(new Vec2(2, 0));
    expect(linearMapVector2(new Vec2(2, 2), new Vec2(2, 2), new Vec2(1, 1), new Vec2(2, 1), new Vec2(1, 1))).toEqual(new Vec2(2, 1));
    expect(linearMapVector2(new Vec2(2, 2), new Vec2(2, 2), new Vec2(1, 1), new Vec2(2, 2), new Vec2(1, 1))).toEqual(new Vec2(2, 2));
    expect(linearMapVector2(new Vec2(3, 3), new Vec2(2, 2), new Vec2(1, 1), new Vec2(2, 2), new Vec2(1, 1))).toEqual(new Vec2(3, 3));
    expect(linearMapVector2(new Vec2(3, 3), new Vec2(2, 2), new Vec2(2, 1), new Vec2(2, 2), new Vec2(1, 1))).toEqual(new Vec2(2.5, 3));
    expect(linearMapVector2(new Vec2(3, 3), new Vec2(2, 2), new Vec2(4, 1), new Vec2(2, 2), new Vec2(1, 1))).toEqual(new Vec2(2.25, 3));
    expect(linearMapVector2(new Vec2(3, 3), new Vec2(2, 2), new Vec2(4, 2), new Vec2(2, 2), new Vec2(1, 1))).toEqual(new Vec2(2.25, 2.5));
    expect(linearMapVector2(new Vec2(3, 3), new Vec2(2, 2), new Vec2(4, 4), new Vec2(2, 2), new Vec2(1, 1))).toEqual(new Vec2(2.25, 2.25));
    expect(linearMapVector2(new Vec2(3, 3), new Vec2(2, 2), new Vec2(4, 4), new Vec2(2, 2), new Vec2(2, 1))).toEqual(new Vec2(2.5, 2.25));
    expect(linearMapVector2(new Vec2(3, 3), new Vec2(2, 2), new Vec2(4, 4), new Vec2(2, 2), new Vec2(4, 1))).toEqual(new Vec2(3, 2.25));
    expect(linearMapVector2(new Vec2(3, 3), new Vec2(2, 2), new Vec2(4, 4), new Vec2(2, 2), new Vec2(4, 2))).toEqual(new Vec2(3, 2.5));
    expect(linearMapVector2(new Vec2(3, 3), new Vec2(2, 2), new Vec2(4, 4), new Vec2(2, 2), new Vec2(4, 4))).toEqual(new Vec2(3, 3));
});
test('minPositive', () => {
