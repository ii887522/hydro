...
import AvlTree from '../../../src/collection/AvlTree.js'
...
test('AvlTree::toArrayPreorder', () => {
  ...
  expect(tree.toArrayPreorder())
    .toEqual([{ key: 1, value: 'a' }, { key: 0, value: 'b' }, { key: 2, value: 'c' }, { key: 3, value: 'd' }])
  tree.put(4, 'e')
  expect(tree.toArrayPreorder())
    .toEqual([
      { key: 1, value: 'a' },
...
test('AvlTree::toArrayInorder', () => {
  ...
  expect(tree.toArrayInorder())
    .toEqual([{ key: 0, value: 'b' }, { key: 1, value: 'a' }, { key: 2, value: 'c' }, { key: 3, value: 'd' }])
  tree.put(4, 'e')
  expect(tree.toArrayInorder())
    .toEqual([
      { key: 0, value: 'b' },
...
test('AvlTree::toArrayPostorder', () => {
  ...
  expect(tree.toArrayPostorder())
    .toEqual([{ key: 0, value: 'b' }, { key: 3, value: 'd' }, { key: 2, value: 'c' }, { key: 1, value: 'a' }])
  tree.put(4, 'e')
  expect(tree.toArrayPostorder())
    .toEqual([
      { key: 0, value: 'b' },
