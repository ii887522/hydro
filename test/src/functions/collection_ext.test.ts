...
test(
  'merge sort an array that contains 11 elements in descending order with assumption that there are 2 elements in each sorted run',
  () => {
    const numbers = [3, 2, 3, 0, 4, 8, 6, 1, 5, 9, 7]
...
test('toArray', () => {
  ...
  expect(toArray({ 2: [{ value: 2, numbersHash: () => [2] }] }).map(obj => ({ value: obj.value })))
    .toEqual([{ value: 2 }])
  expect(
    toArray({ 0: [{ value: 2, numbersHash: () => [2, 0] }], 2: [{ value: 2, numbersHash: () => [2, 0] }] })
      .map(obj => ({ value: obj.value }))
  ).toEqual([{ value: 2 }])
  expect(
    toArray({ 1: [{ value: 2, numbersHash: () => [2, 1] }], 2: [{ value: 2, numbersHash: () => [2, 1] }] })
      .map(obj => ({ value: obj.value }))
  ).toEqual([{ value: 2 }])
  expect(
    toArray({ 1: [{ value: 2, numbersHash: () => [3, 1] }], 3: [{ value: 2, numbersHash: () => [3, 1] }] })
      .map(obj => ({ value: obj.value }))
  ).toEqual([{ value: 2 }])
  expect(
    toArray({
...
test('toMap', () => {
  ...
  expect(
    Object.entries(toMap([{ value: 0, numbersHash: () => [0] }]))
      .reduce((map, [key, array]) => ({ ...map, [key]: array.map(object => ({ value: object.value })) }), { })
  ).toEqual({ 0: [{ value: 0 }] })
  expect(
    Object.entries(toMap([{ value: 1, numbersHash: () => [0] }]))
      .reduce((map, [key, array]) => ({ ...map, [key]: array.map(object => ({ value: object.value })) }), { })
  ).toEqual({ 0: [{ value: 1 }] })
  expect(
    Object.entries(toMap([{ value: 2, numbersHash: () => [0] }]))
      .reduce((map, [key, array]) => ({ ...map, [key]: array.map(object => ({ value: object.value })) }), { })
  ).toEqual({ 0: [{ value: 2 }] })
  expect(
    Object.entries(toMap([{ value: 2, numbersHash: () => [1] }]))
      .reduce((map, [key, array]) => ({ ...map, [key]: array.map(object => ({ value: object.value })) }), { })
  ).toEqual({ 1: [{ value: 2 }] })
  expect(
    Object.entries(toMap([{ value: 2, numbersHash: () => [2] }]))
      .reduce((map, [key, array]) => ({ ...map, [key]: array.map(object => ({ value: object.value })) }), { })
  ).toEqual({ 2: [{ value: 2 }] })
  expect(
    Object.entries(toMap([{ value: 2, numbersHash: () => [2, 0] }]))
      .reduce((map, [key, array]) => ({ ...map, [key]: array.map(object => ({ value: object.value })) }), { })
  ).toEqual({ 0: [{ value: 2 }], 2: [{ value: 2 }] })
  expect(
    Object.entries(toMap([{ value: 2, numbersHash: () => [2, 1] }]))
      .reduce((map, [key, array]) => ({ ...map, [key]: array.map(object => ({ value: object.value })) }), { })
  ).toEqual({ 1: [{ value: 2 }], 2: [{ value: 2 }] })
  expect(
    Object.entries(toMap([{ value: 2, numbersHash: () => [3, 1] }]))
      .reduce((map, [key, array]) => ({ ...map, [key]: array.map(object => ({ value: object.value })) }), { })
  ).toEqual({ 1: [{ value: 2 }], 3: [{ value: 2 }] })
  expect(
    Object.entries(toMap([{ value: 2, numbersHash: () => [3, 1, 0] }]))
      .reduce((map, [key, array]) => ({ ...map, [key]: array.map(object => ({ value: object.value })) }), { })
  ).toEqual({ 0: [{ value: 2 }], 1: [{ value: 2 }], 3: [{ value: 2 }] })
  expect(
    Object.entries(toMap([{ value: 2, numbersHash: () => [3, 1, 0] }, { value: 0, numbersHash: () => [2] }]))
      .reduce((map, [key, array]) => ({ ...map, [key]: array.map(object => ({ value: object.value })) }), { })
  ).toEqual({ 0: [{ value: 2 }], 1: [{ value: 2 }], 2: [{ value: 0 }], 3: [{ value: 2 }] })
  expect(
    Object.entries(toMap([{ value: 2, numbersHash: () => [3, 1, 0] }, { value: 1, numbersHash: () => [2] }]))
      .reduce((map, [key, array]) => ({ ...map, [key]: array.map(object => ({ value: object.value })) }), { })
  ).toEqual({ 0: [{ value: 2 }], 1: [{ value: 2 }], 2: [{ value: 1 }], 3: [{ value: 2 }] })
  expect(
    Object.entries(toMap([{ value: 3, numbersHash: () => [3, 1, 0] }, { value: 1, numbersHash: () => [2] }]))
      .reduce((map, [key, array]) => ({ ...map, [key]: array.map(object => ({ value: object.value })) }), { })
  ).toEqual({ 0: [{ value: 3 }], 1: [{ value: 3 }], 2: [{ value: 1 }], 3: [{ value: 3 }] })
  expect(
    Object.entries(
      toMap([
...
test('add', () => {
  expect(add({ }, { })).toEqual({ })
  expect(
    Object.entries(add({ 0: [{ value: 0, numbersHash: () => [0] }] }, { }))
      .reduce((map, [key, array]) => ({ ...map, [key]: array.map(object => ({ value: object.value })) }), { })
  ).toEqual({ 0: [{ value: 0 }] })
  expect(
    Object.entries(add({ 0: [{ value: 1, numbersHash: () => [0] }] }, { }))
      .reduce((map, [key, array]) => ({ ...map, [key]: array.map(object => ({ value: object.value })) }), { })
  ).toEqual({ 0: [{ value: 1 }] })
  expect(
    Object.entries(add({ 0: [{ value: 2, numbersHash: () => [0] }] }, { }))
      .reduce((map, [key, array]) => ({ ...map, [key]: array.map(object => ({ value: object.value })) }), { })
  ).toEqual({ 0: [{ value: 2 }] })
  expect(
    Object.entries(add({ 1: [{ value: 2, numbersHash: () => [1] }] }, { }))
      .reduce((map, [key, array]) => ({ ...map, [key]: array.map(object => ({ value: object.value })) }), { })
  ).toEqual({ 1: [{ value: 2 }] })
  expect(
    Object.entries(add({ 2: [{ value: 2, numbersHash: () => [2] }] }, { }))
      .reduce((map, [key, array]) => ({ ...map, [key]: array.map(object => ({ value: object.value })) }), { })
  ).toEqual({ 2: [{ value: 2 }] })
  expect(
    Object.entries(
      add({ 0: [{ value: 2, numbersHash: () => [2, 0] }], 2: [{ value: 2, numbersHash: () => [2, 0] }] }, { })
    ).reduce((map, [key, array]) => ({ ...map, [key]: array.map(object => ({ value: object.value })) }), { })
  ).toEqual({ 0: [{ value: 2 }], 2: [{ value: 2 }] })
  expect(
    Object.entries(
      add({ 1: [{ value: 2, numbersHash: () => [2, 1] }], 2: [{ value: 2, numbersHash: () => [2, 1] }] }, { })
    ).reduce((map, [key, array]) => ({ ...map, [key]: array.map(object => ({ value: object.value })) }), { })
  ).toEqual({ 1: [{ value: 2 }], 2: [{ value: 2 }] })
  expect(
    Object.entries(
      add({ 1: [{ value: 2, numbersHash: () => [3, 1] }], 3: [{ value: 2, numbersHash: () => [3, 1] }] }, { })
    ).reduce((map, [key, array]) => ({ ...map, [key]: array.map(object => ({ value: object.value })) }), { })
  ).toEqual({ 1: [{ value: 2 }], 3: [{ value: 2 }] })
  expect(
    Object.entries(
  ...
  ).toEqual({ 0: [{ value: 2 }, { value: 0 }], 1: [{ value: 2 }], 3: [{ value: 2 }] })
  expect(
    Object.entries(
      add(
        {
  ...
  ).toEqual({ 0: [{ value: 2 }, { value: 1 }], 1: [{ value: 2 }], 3: [{ value: 2 }] })
  expect(
    Object.entries(
      add(
        {
  ...
  ).toEqual({ 0: [{ value: 2 }, { value: 2 }], 1: [{ value: 2 }], 3: [{ value: 2 }] })
  expect(
    Object.entries(
      add(
        {
  ...
  ).toEqual({ 0: [{ value: 2 }], 1: [{ value: 2 }, { value: 2 }], 3: [{ value: 2 }] })
  expect(
    Object.entries(
      add(
        {
  ...
  ).toEqual({ 0: [{ value: 2 }], 1: [{ value: 2 }], 2: [{ value: 2 }], 3: [{ value: 2 }] })
  expect(
    Object.entries(
      add(
        {
  ...
  ).toEqual({ 0: [{ value: 2 }], 1: [{ value: 2 }, { value: 2 }], 2: [{ value: 2 }], 3: [{ value: 2 }] })
  expect(
    Object.entries(
      add(
        {
  ...
  ).toEqual({ 0: [{ value: 2 }], 1: [{ value: 2 }, { value: 2 }], 3: [{ value: 2 }, { value: 2 }] })
  expect(
    Object.entries(
      add(
        {
...
test('subtract', () => {
  ...
  expect(
    Object.entries(subtract({ 0: [{ value: 0, numbersHash: () => [0] }] }, { }))
      .reduce((map, [key, array]) => ({ ...map, [key]: array.map(object => ({ value: object.value })) }), { })
  ).toEqual({ 0: [{ value: 0 }] })
  expect(
    Object.entries(subtract({ 0: [{ value: 1, numbersHash: () => [0] }] }, { }))
      .reduce((map, [key, array]) => ({ ...map, [key]: array.map(object => ({ value: object.value })) }), { })
  ).toEqual({ 0: [{ value: 1 }] })
  expect(
    Object.entries(subtract({ 0: [{ value: 2, numbersHash: () => [0] }] }, { }))
      .reduce((map, [key, array]) => ({ ...map, [key]: array.map(object => ({ value: object.value })) }), { })
  ).toEqual({ 0: [{ value: 2 }] })
  expect(
    Object.entries(subtract({ 1: [{ value: 2, numbersHash: () => [1] }] }, { }))
      .reduce((map, [key, array]) => ({ ...map, [key]: array.map(object => ({ value: object.value })) }), { })
  ).toEqual({ 1: [{ value: 2 }] })
  expect(
    Object.entries(subtract({ 2: [{ value: 2, numbersHash: () => [2] }] }, { }))
      .reduce((map, [key, array]) => ({ ...map, [key]: array.map(object => ({ value: object.value })) }), { })
  ).toEqual({ 2: [{ value: 2 }] })
  expect(
    Object.entries(
      subtract({ 0: [{ value: 2, numbersHash: () => [2, 0] }], 2: [{ value: 2, numbersHash: () => [2, 0] }] }, { })
    ).reduce((map, [key, array]) => ({ ...map, [key]: array.map(object => ({ value: object.value })) }), { })
  ).toEqual({ 0: [{ value: 2 }], 2: [{ value: 2 }] })
  expect(
    Object.entries(
      subtract({ 1: [{ value: 2, numbersHash: () => [2, 1] }], 2: [{ value: 2, numbersHash: () => [2, 1] }] }, { })
    ).reduce((map, [key, array]) => ({ ...map, [key]: array.map(object => ({ value: object.value })) }), { })
  ).toEqual({ 1: [{ value: 2 }], 2: [{ value: 2 }] })
  expect(
    Object.entries(
      subtract({ 1: [{ value: 2, numbersHash: () => [3, 1] }], 3: [{ value: 2, numbersHash: () => [3, 1] }] }, { })
    ).reduce((map, [key, array]) => ({ ...map, [key]: array.map(object => ({ value: object.value })) }), { })
  ).toEqual({ 1: [{ value: 2 }], 3: [{ value: 2 }] })
  expect(
    Object.entries(
