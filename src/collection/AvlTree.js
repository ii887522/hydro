...
export default class AvlTree {
    ...
    flipRight(from) {
        ...
        requireDefined(requireDefined(from.parent).left).rightHeight = leftNode !== undefined
            ...
            : 0;
        requireDefined(from.parent).leftHeight = Math.max(requireDefined(requireDefined(from.parent).left).leftHeight, requireDefined(requireDefined(from.parent).left).rightHeight) + 1;
        requireDefined(from.parent).rightHeight = Math.max(from.leftHeight, from.rightHeight) + 1;
    ...
    flipLeft(from) {
        ...
        requireDefined(requireDefined(from.parent).right).leftHeight = rightNode !== undefined
            ...
            : 0;
        requireDefined(from.parent).leftHeight = Math.max(from.leftHeight, from.rightHeight) + 1;
        requireDefined(from.parent).rightHeight = Math.max(requireDefined(requireDefined(from.parent).right).leftHeight, requireDefined(requireDefined(from.parent).right).rightHeight) + 1;
        if (leftNode !== undefined)
